...
class Goblin(Enemy):
    def __init__(self, pos, frames, groups, collision_sprites, data):
        super().__init__(pos, frames, groups, data, state='run', health=3)
...
class Gunner(Enemy):
    def __init__(self, pos, frames, groups, collision_sprites, player, create_bullet, data):
        super().__init__(pos, frames, groups, data, state='idle', health=3)
...
class Crate(Enemy):
    def __init__(self, pos, frames, groups, player, create_fly, data):
        super().__init__(pos, frames, groups, data, state='idle', health=5)
...
class Fly(Enemy):
    def __init__(self, pos, frames, groups, surf, collision_sprites, player):
        super().__init__(pos, frames, groups, data = None, state='die', health=2)
        self.image = self.frames[self.state][self.frame_index]
        self.player = player
        self.health = 2
        self.collision_rects = [sprite.rect for sprite in collision_sprites]
